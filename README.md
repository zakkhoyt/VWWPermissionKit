...
## YSK that Apple is currently denying apps which use this framework if the app doesn't use HealthKit or HomeKit. I am aware of this issue and looking at ways to implement a fix. It is #1 priority. Pull requests are welcome. You can still develop with it in the mean time. ##
